...
function wedding_styles()
{
    ...
    // JavaScript
    wp_enqueue_script('jquery', esc_url(get_template_directory_uri()) . '/js/jquery-3.7.1.min.js', array(), "3.7.1");
    wp_enqueue_script('owl.carousel-js', esc_url(get_template_directory_uri()) . '/js/owl.carousel.min.js', array('jquery'), "2.3.4");
}
